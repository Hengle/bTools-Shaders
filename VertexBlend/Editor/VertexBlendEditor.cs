...
public class VertexBlendEditor : Editor
{
	...
	private void OnEnable()
	{
		...
		//targetMat = blendee.GetComponent<MeshRenderer>().sharedMaterial;
	...
	public override void OnInspectorGUI()
	{
		...
		//brush.falloffRadius = EditorGUILayout.Slider( "Falloff", brush.falloffRadius, 0, 1 );
		#endregion
		...
		if ( showExtra )
		{
			...
			//if ( GUILayout.Button( "Create Texture Array ", EditorStyles.miniButton ) )
			//{
			//	Texture2DArray newArray = new Texture2DArray( 1024, 1024, 4, TextureFormat.ARGB32, true );
			//	AssetDatabase.CreateAsset( newArray, "Assets/MyArray.asset" );
